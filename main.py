    ...
    try:
        ...
        if cloudtype == 'moodle':
            ...
            if loged:
                ...
                bot.editMessageText(message,'âŒError En La PaginaâŒ')
...
def processFile(update,bot,message,file,thread=None,jdb=None):
 ...
 t(message,'âŒError En La Paginaâ„1¤7')
    ...
    try:
        ...
        if '/tokenize_on' in msgText:
            try:
                ...
                bot.sendMessage(update.message.chat.id,'âŒError en el comando /tokenize stateâ  return
